      ...
      <div className="legal-page__container">
        ...
        <div className="legal-page__content">
          ...
          <section className="legal-page__section">
            ...
            <ul>
              <li><strong>Your device's advertising identifier (IDFA).</strong> We do not collect or use it, and we do not track you across other companies' apps and websites</li>
            ...
            <h3>How We Measure Ads Without Tracking You</h3>
            <p>
              We rely on Apple's SKAdNetwork, which reports ad performance to us in an aggregated, privacy-preserving form. It tells us that an ad led to installs or subscriptions without identifying who you are. Because we do not use the advertising identifier, <strong>the app does not ask you for tracking permission</strong> — there is no App Tracking Transparency prompt to accept or decline.
            </p>
          </section>
          ...
          <section className="legal-page__section">
            ...
            <ul>
              ...
              <li>Know that we do not track you across other companies' apps or websites, and do not use your device's advertising identifier (see section 5)</li>
